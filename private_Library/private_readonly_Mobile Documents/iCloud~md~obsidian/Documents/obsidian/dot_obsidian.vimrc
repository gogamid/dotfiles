...
nmap <Space>fn :newFile
nmap <Space>fd :delFile

exmap toggleLeftSidebar obcommand app:toggle-left-sidebar
exmap toggleRightSidebar obcommand app:toggle-right-sidebar
nmap <Space>al :toggleLeftSidebar
nmap <Space>ar :toggleRightSidebar
...
vmap <Space>eb :bulletList
nmap <Space>eb :bulletList
